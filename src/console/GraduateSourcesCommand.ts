...
program
  ...
  .option(
    '-I, --ensureFieldIntegrity',
    'When specified, the graduation will fail if at least source to graduate references fields that do not exist in the desintation org',
    false
  )
  .option(
    '-S, --ignoreSources []',
  ...
  .action((origin: string, destination: string, apiKey: string[], options: any) => {
    ...
    const graduateOptions: IGraduateOptions = {
      ...
      ensureFieldIntegrity: options.ensureIntegrity,
